...
export default function RejectedOrderContent() {
    ...
    const fetchOrdersWithItems = () => {
        ...
        const ordersQuery = query(
            ...
            orderBy("createdAt", "desc"), where("status", "==", "Rejected" )
        );
    ...
    const exportOrdersPDF = (orders) => {
        ...
        doc.setFontSize(18);
        doc.text("Rejected Orders Report", 14, 20);
        ...
        <section className="mt-3">
            <div className="flex items-center justify-between my-10">
                <h3 className="font-[mulish] text-2xl font-semibold text-gray-700 tracking-wide">
                    {`Rejected Orders (${String(ordersWithItems.length).padStart("2", 0)}) `}
                </h3>
                    ...
                    <div className="px-4">
                        {detailLoading ? (
                            ...
                            <>
                                ...
                                <div  className="bg-[#ff0000] cursor-not-allowed text-white w-full h-[44px] my-3 flex items-center justify-center rounded-md">
