        ...
        <section className="mt-3">
            <div className="flex items-center justify-between my-10">
                <h3 className="font-[mulish] text-2xl font-semibold text-gray-700 tracking-wide">
                    {` Completed Orders (${String(ordersWithItems.length).padStart("2", 0)}) `}
                </h3>
                <div className="flex items-center gap-2 justify-between max-w-[350px] w-full h-[44px] px-2 bg-[#f6f6f6] rounded-md shadow">
                        ...
                        <div className="px-4">
                            {detailLoading ? (
                                ...
                                <>
                                    ...
                                    <div  className="bg-[#016d2c] cursor-not-allowed text-white w-full h-[44px] my-3 flex items-center justify-center rounded-md">
